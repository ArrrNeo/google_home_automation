...
- - * create a simple python server, that can handle POST.
- - * in AP setting setup port forwarding to your server ip (raspberry pi's address) and port.
- - * find out public IP address if your home network. this will be needed later to configure IFTTT
- - * in POST request handler, issue LIRC irsend comamnd to control TV.
